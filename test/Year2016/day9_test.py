...
from src.Year2016.Day9 import Day9
...
class Day9Test(TestCase):
    ...
    def test_base(self):
        encrypted = 'ADVENT'
        self.assertEqual(len(self.day.decrypt_v1(encrypted)), 6)
        encrypted = 'A(1x5)BC'
        self.assertEqual(self.day.decrypt_v1(encrypted), 'ABBBBBC')
        self.assertEqual(len(self.day.decrypt_v1(encrypted)), 7)
        encrypted = '(3x3)XYZ'
        self.assertEqual(self.day.decrypt_v1(encrypted), 'XYZXYZXYZ')
        self.assertEqual(len(self.day.decrypt_v1(encrypted)), 9)
        encrypted = 'A(2x2)BCD(2x2)EFG'
        self.assertEqual(self.day.decrypt_v1(encrypted), 'ABCBCDEFEFG')
        self.assertEqual(len(self.day.decrypt_v1(encrypted)), 11)
        encrypted = '(6x1)(1x3)A'
        self.assertEqual(self.day.decrypt_v1(encrypted), '(1x3)A')
        self.assertEqual(len(self.day.decrypt_v1(encrypted)), 6)
        encrypted = 'X(8x2)(3x3)ABCY'
        self.assertEqual(self.day.decrypt_v1(encrypted), 'X(3x3)ABC(3x3)ABCY')
        self.assertEqual(len(self.day.decrypt_v1(encrypted)), 18)

    def test_puzzle(self):
        self.assertEqual(len(self.day.decrypt_v1(self.puzzle())), 70186)

    def test_simple_part2(self):
        encrypted = 'ADVENT'
        self.assertEqual(self.day.decrypt_v2(encrypted)[0], 6)
        encrypted = 'A(1x5)BC'
        self.assertEqual(self.day.decrypt_v2(encrypted)[0], 7)
        self.assertEqual(self.day.decrypt_v2(encrypted, True)[1], 'ABBBBBC')
        encrypted = '(3x3)XYZ'
