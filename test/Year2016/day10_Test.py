...
from src.Year2016.Day10 import Day10
...
value 2 goes to bot 2'''
        self.assertEqual(self.day.process(instructions), {0: 5, 1: 2, 2: 3})
        self.assertEqual(self.day.highlight_bot, 2)

    def test_puzzle(self):
        self.day.highlight = (17, 61)
        result = self.day.process(self.puzzle())
        self.assertEqual(result,
                         {0: 19, 1: 67, 2: 37, 3: 31, 4: 47, 5: 61, 6: 43, 7: 13, 8: 73, 9: 3,
                          10: 11, 11: 2, 12: 7, 13: 23, 14: 53, 15: 5, 16: 71, 17: 59, 18: 17,
                          19: 41, 20: 29})
        self.assertEqual(self.day.highlight_bot, 93)
        self.assertEqual(result[0] * result[1] * result[2], 47101)

    def puzzle(self):
        return '''bot 135 gives low to bot 27 and high to bot 166
