...
from src.Year2015.Day6 import Day6
...
class Day6Test(TestCase):
    ...
    def test_one_brightness(self):
        self.assertEqual(1, self.day.calc_bright('turn on 0,0 through 0,0'))

    def test_all_brightness(self):
        self.assertEqual(2000000, self.day.calc_bright('toggle 0,0 through 999,999'))

    def test_all_light(self):
        self.assertEqual(1000000, self.day.calc('turn on 0,0 through 999,999'))

    def test_toggle_first_line(self):
        self.assertEqual(1000, self.day.calc('toggle 0,0 through 999,0'))
    ...
    def test_puzzle(self):
        self.assertEqual(377891, self.day.calc(self.puzzle()))
        self.assertEqual(14110788, self.day.calc_bright(self.puzzle()))
