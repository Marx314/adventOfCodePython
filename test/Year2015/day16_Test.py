...
from src.Year2015.Day16 import Day16
...
class Day16Test(TestCase):
    ...
    def test_find_the_sue_in_sue(self):
        self.assertEqual(373, self.day.find_sue(self.puzzle()))

    def test_puzzle_best_cookie(self):
        self.assertEqual(260, self.day.find_sue_issue(self.puzzle()))
