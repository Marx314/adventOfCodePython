...
from src.Year2015.Day13 import Day13
...
class Day13Test(TestCase):
    ...
    def test_small_table(self):
        self.assertEqual(330, self.day.seating(self.simple_puzzle()))

    def test_puzzle(self):
        self.assertEqual(618, self.day.seating(self.puzzle()))
        self.assertEqual(601, self.day.seating(self.puzzle(), me=True))
...
David would gain 41 happiness units by sitting next to Carol.'''
    ...
    def puzzle(self):
        return '''Alice would lose 57 happiness units by sitting next to Bob.
